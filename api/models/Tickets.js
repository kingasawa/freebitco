...
module.exports = {
  ...
  fetchAll: async({userId}) => {
    ...
    const amountWon = totalWinnerTickets * setting.PRICE_PER_TICKET
    ...
    const responseData = {
      ...
      price_per_ticket: setting.PRICE_PER_TICKET
    }
    return responseData
  },
  ...
  buy: async({userId, numberTickets}) => {
    ...
    const totalTicketAmount = parseFloat(numberTickets) * setting.PRICE_PER_TICKET
